<template>
    <q-page padding>
        <q-list highlight no-border>
            <q-item multiline>
                <q-item-side image="statics/avatar/male_1.svg" />
                <q-item-main>
                    <q-item-tile label>Thavorac</q-item-tile>
                    <q-item-tile sublabel lines="4">
                        <br/>
                        <q-icon name="person pin" /> Phnom Penh, Cambodida
                        <q-icon name="markunread" /> thavorac.chun@gmail.com
                        <q-icon name="perm phone msg" /> (+855)966000880
                    </q-item-tile>
                </q-item-main>
            </q-item>
        </q-list>
